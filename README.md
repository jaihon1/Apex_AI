...
## Objective
  * Have Fun.
  * Train single agent to play Apex Legends (Agent + Human + Human).
  * Group single agents together to work in team (Agent_0 + Agent_1 + Agent_2).

## Concepts
  * Convolutional Neural Network
  * Reinforcment Learning (Deep Q-Learning)
